...
export function Ayarlar(props: AyarlarProps) {
  return (
    <>
      ...
      <a className="font-inter text-sm font-medium tracking-tight text-slate-500 hover:text-slate-300 px-4 py-3 hover:bg-slate-900 transition-all duration-150 flex items-center gap-3 mx-2 rounded-lg" href="#">
      ...
      {/* Active Tab */}
      <a className="font-inter text-sm font-medium tracking-tight bg-blue-600/10 text-blue-400 border-r-4 border-blue-500 shadow-[0_0_10px_rgba(37,99,235,0.3)] px-4 py-3 flex items-center gap-3 translate-x-1" href="#">
      ...
      <a className="font-inter text-sm font-medium tracking-tight text-slate-500 hover:text-slate-300 px-4 py-3 hover:bg-slate-900 transition-all duration-150 flex items-center gap-3 rounded-lg" href="#">
      <span className="material-symbols-outlined">account_circle</span>
                      Profil
                  </a>
      <a className="font-inter text-sm font-medium tracking-tight text-slate-500 hover:text-slate-300 px-4 py-3 hover:bg-slate-900 transition-all duration-150 flex items-center gap-3 rounded-lg text-error hover:text-error-container" href="#">
      ...
      <label className="flex items-center justify-between p-sm rounded-lg border border-primary-container bg-primary-container/10 shadow-[0_0_8px_theme(colors.primary-container/20)] cursor-pointer">
      <div className="flex items-center gap-md">
      <span className="material-symbols-outlined text-primary">dark_mode</span>
      <span className="font-label-tr text-label-tr text-on-surface">Karanlık (Aktif)</span>
      </div>
      ...
      <label className="flex items-center justify-between p-sm rounded-lg border border-outline-variant hover:bg-surface-variant/50 cursor-pointer transition-colors">
      <div className="flex items-center gap-md">
      <span className="material-symbols-outlined text-on-surface-variant">light_mode</span>
      <span className="font-label-tr text-label-tr text-on-surface-variant">Aydınlık</span>
      </div>
      ...
      <select className="w-full appearance-none bg-surface-dim border border-outline-variant text-on-surface font-body-tr text-body-tr rounded-lg px-4 py-3 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all">
      ...
      <button className="mt-4 w-full bg-error-container/20 text-error border border-error/50 hover:bg-error hover:text-on-error font-label-tr text-label-tr uppercase py-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-2">
      ...
      <span className="font-mono-tr text-mono-tr text-primary">1.5s</span>
      </div>
      <input className="w-full h-1 bg-surface-dim rounded-full appearance-none cursor-pointer accent-primary" max="5" min="0.5" step="0.5" type="range" value="1.5" />
      ...
      <div className="flex items-center gap-4 bg-surface-dim p-2 rounded-lg border border-outline-variant">
      ...
      <div className="w-10 h-5 bg-primary rounded-full relative cursor-pointer shadow-[0_0_8px_theme(colors.primary/40)]">
      <div className="w-4 h-4 bg-on-primary rounded-full absolute right-0.5 top-0.5"></div>
      </div>
      </div>
      </div>
      </div>
      <div className="mt-4 pt-4 border-t border-surface-variant flex justify-end">
      <button className="bg-primary text-on-primary font-label-tr text-label-tr uppercase px-6 py-2.5 rounded-lg hover:bg-primary-fixed transition-colors shadow-[0_0_12px_theme(colors.primary/20)] flex items-center gap-2">
      ...
      <a className="flex flex-col items-center justify-center w-full h-full text-slate-500 hover:text-slate-300" href="#">
      <span className="material-symbols-outlined">assignment_late</span>
      ...
      <a className="flex flex-col items-center justify-center w-full h-full text-blue-400" href="#">
